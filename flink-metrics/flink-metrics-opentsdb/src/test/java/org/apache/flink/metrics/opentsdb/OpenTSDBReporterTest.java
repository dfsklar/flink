...
public class OpenTSDBReporterTest extends TestLogger {
	...
	public void testReplaceInvalidChars() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		...
		reporter.setFakeTimestamp(123456L);
	...
	public void testAddingMetrics() throws NoSuchFieldException, IllegalAccessException {
		...
		configuration.setString(
				...
				"org.apache.flink.metrics.opentsdb.OpentsdbReporterTest$TestingOpentsdbReporter");
		...
		assertTrue("Reporter should be of type OpentsdbReporter", metricReporter instanceof OpentsdbReporter);

		TestingOpentsdbReporter reporter = (TestingOpentsdbReporter) metricReporter;
	...
	/**
	 * Tests that histograms are properly reported via the Opentsdb reporter
	 */
	@Test
	public void testOpentsdbHistogramReporting() throws Exception {
		...
		try {
			...
			config.setString(ConfigConstants.METRICS_REPORTER_PREFIX + "test." + ConfigConstants.METRICS_REPORTER_CLASS_SUFFIX, OpentsdbReporter.class.getName());
	...
	/**
	 * Tests that meters are properly reported via the Opentsdb reporter
	 */
	@Test
	public void testOpentsdbMetersReporting() throws Exception {
		MetricRegistry registry = null;
		DatagramSocketReceiver receiver = null;
		Thread receiverThread = null;
		long timeout = 5000;
	...
	/**
	 * Testing OpentsdbReporter which disables the socket creation
	 */
	public static class TestingOpentsdbReporter extends OpentsdbReporter {
		@Override
		public void open(MetricConfig configuration) {
		    this.setFakeTimestamp(123456L);
